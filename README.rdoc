...
Hier könnt ihr euch angucken, wie man die Readme formatiert: https://github.com/adam-p/markdown-here/wiki/Markdown-Cheatsheet

== Userstories
* Ein User soll Alben mit Name und Beschreibung anlegen können
* Ein User soll Alben bearbeiten und löschen können
* Ein User soll einem Album ein oder mehrere Fotos mit Namen zuordnen können
* Ein User soll ein Foto löschen können
* Ein User soll Kalender-Event erstellen können
* Ein User soll Kalender-Event editieren können
* Ein User soll Kalender-Event löschen können
